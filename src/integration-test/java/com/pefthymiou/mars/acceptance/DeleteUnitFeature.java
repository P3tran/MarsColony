...
public class DeleteUnitFeature {
    ...
    @Test
    public void deleteAnExistingUnitAsAdmin() throws Exception {
        givenAUnit();

        anAdminShouldBeAbleToDeleteTheUnit();
    }

    @Test
    public void notAllowedToDeleteAnExistingUnitAsColonist() throws Exception {
        givenAUnit();

        aColonistShouldNotBeAllowedToDeleteTheUnit();
    }
    ...
    private void anAdminShouldBeAbleToDeleteTheUnit() throws Exception {
    ...
    private void aColonistShouldNotBeAllowedToDeleteTheUnit() throws Exception {
        mockMvc.perform(delete(location)
